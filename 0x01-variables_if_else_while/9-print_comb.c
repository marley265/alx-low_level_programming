 ...
 * FUNCTIONALITY *
 *
 * 1. Loop is initialized with the variable digit set to the character ‘0’.
 ...
 * 4. Loop prints the value of digit, then checks if it is equal to ‘9’.
 * 5. If digit is equal to ‘9’, the continue statement is executed.
 * 6. If digit is not equal to ‘9’, the program prints a comma and a space.
